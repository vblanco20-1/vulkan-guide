...
for (int i = 0; i < FRAME_OVERLAP; i++)
{
		...
		VkWriteDescriptorSet objectWrite = vkinit::write_descriptor_buffer(VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC, _frames[i].objectDescriptor, &objectBufferInfo, 0);
