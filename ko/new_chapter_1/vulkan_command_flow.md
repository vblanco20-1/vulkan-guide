...
GPU의 모든 명령은 VkCommandBuffer에 기록됩니다. GPU의 작업을 수행하는 모든 함수는 커맨드 버퍼가 `VkQueueSubmit`을 통해 GPU로 제출될 때까지 실행되지 않습니다.
...
다음 글: [ Vulkan 명령 구성하기]({{ site.baseurl }}{% link docs/new_chapter_1/vulkan_commands_code.md %})  
